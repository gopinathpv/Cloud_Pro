...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530">
            ...
            <div class="header_02">Share the File to whom you want to Share!!!</div>
           
            <h3>${sessionScope["file_name"]}</h3>
            <form name="" action="Share.jsp">
            <table>
                <tr>
                    <td>user 1:</td><td><input type="text" name="shared_user" value=""/></td></tr>
                     <tr> <td>user 2: </td><td><input type="text" name="shared_user" value=""/></td></tr>
                     <tr>  <td>user 3:</td><td><input type="text" name="shared_user" value=""/></td></tr>
