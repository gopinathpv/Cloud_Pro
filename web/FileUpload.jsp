...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
     ...
     <form action="StoreFiles.jsp" method="post" enctype="multipart/form-data" name="form1" id="form1">
   <center>
       <table width="500" >
       <tr>
               <td>
           ...
           <td><input type="text" name="selected_filename"/></td>
           </tr>
       <tr>
               <td>
                       Specify file:
